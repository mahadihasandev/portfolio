...
export function Hero() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-slate-900 dark:to-black">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative order-1 md:order-2">
            ...
            <img
              ...
              alt="Mahadi Hasan"
              className="relative max-w-[400px] w-full h-auto mx-auto rounded-[500%] shadow-2xl transform hover:scale-105 transition-transform duration-500"
              loading="lazy"
            />
          </div>
