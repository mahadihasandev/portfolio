...
export function AboutCard({ icon: Icon, title, description, color }: AboutCardProps) {
  return (
    <div className="relative group">
      ...
      />
      <div className="relative bg-white dark:bg-[#030712] p-6 border border-gray-200 dark:border-gray-700 rounded-xl shadow-md hover:shadow-lg transition-transform duration-300 transform hover:-translate-y-1">
